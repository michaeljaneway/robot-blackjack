...
class Image(GraphicsObject):
    ...
    def change_frame(self, filename, frame):
        """Edit made by Michael Janeway, changes the frame of a gif image"""

        self.img = tk.PhotoImage(file=filename, format="gif -index {}".format(frame))
